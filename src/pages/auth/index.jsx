        ...
        <div className='container'>
            <div className={styles.form_wrapper}>
                <div className={styles.button_wrap}>
                    <button className= {formTitle === "Login" ? `cta active` : `cta`} value="login" onClick={handleFormType}>Login</button>
                    <p>Or</p>
                    <button className= {formTitle === "Register" ? `cta active` : `cta`} value="register" onClick={handleFormType}>Register</button>
                </div>
            {formType === 'login' ? (
                <div>
                   <fieldset>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit(handleLogin)}>
                        ...
                        <button className='cta cta_gradient' type="submit">Login</button>
                        </form>
                    </fieldset>
                </div>) : (
                    <div>
                    <fieldset>
                     ...
                     <form className={styles.form} onSubmit={handleSubmit(handleRegister)}>
                        ...
                        <div className={styles.checkbox_div}>
                            ...
                            <button><img src={informationIcon} alt="information icon"/></button>
                        </div>
                        <button className='cta cta_gradient' type="submit">Register</button>
                        </form>
                     </fieldset>
                 </div>
                )}
